...
||_[Archive]({% link system/action-log-archive.md %})_{:.caption-edition-ee}||
...
||_[Shared Catalog]({% link catalog/catalog-shared.md %})_{:.caption-edition-b2b}| Manage Shared Catalog|
...
||_[Companies]({% link customers/account-companies.md %})_{:.caption-edition-b2b}| [ Manage Companies]({% link customers/account-company-manage.md %}) <br/>Add New Company <br/>Delete Company <br/>Reimburse Balance |
|[Carts]({% link sales/cart.md %})|[Manage carts]({% link sales/cart.md %})||
|[My Account]({% link customers/customer-account.md %})|||
|[Marketing]({% link marketing.md %})|[Promotions]({% link marketing/promotions.md %})|[Catalog Price Rule]({% link marketing/price-rules-catalog.md %}) <br/>[Cart Price Rules]({% link marketing/price-rules-cart.md %}) <br/>_[Related Products Rules]({% link marketing/product-related-rules.md %})_{:.caption-edition-ee}<br/>_[Gift Card Accounts]({% link catalog/product-gift-card-accounts.md %})_{:.caption-edition-ee}|
||_[Private Sales]({% link marketing/events-private-sales.md %})_{:.caption-edition-ee}|[Events]({% link marketing/event-components.md %}) <br/>[Invitations]({% link marketing/invitations.md %})|
||[Communications]({% link marketing/communications.md %})|[Email Templates]({% link marketing/email-templates.md %}) <br/>[Newsletter Template]({% link marketing/newsletter-template.md %}) <br/>[Newsletter Queue]({% link marketing/newsletter-queue.md %}) <br/>[Newsletter Subscribers]({% link marketing/newsletter-subscribers.md %}) <br/>_[Email Reminders]({% link marketing/email-reminder-rules.md %})_{:.caption-edition-ee}|
...
||[SEO & Search]({% link marketing/seo-search.md %})|[Search Terms]({% link marketing/search-terms.md %}) <br/>_[Search Synonyms]({% link marketing/search-synonyms.md %})_{:.caption-edition-ee}<br/>[URL Rewrites]({% link marketing/url-rewrite.md %}) <br/>[Site Map]({% link marketing/sitemap-xml.md %})|
...
|[Content]({% link content.md %}) | [Elements]({% link cms/content-elements.md %}) | [Pages]({% link cms/pages.md %})<br/>_[Hierarchy]({% link cms/page-hierarchy.md %})_{:.caption-edition-ee}<br/>[Blocks]({% link cms/blocks.md %})<br/>_[Dynamic Blocks]({% link cms/dynamic-blocks.md %})_{:.caption-edition-ee}<br/>[Widgets]({% link cms/widgets.md %})<br/>[Media Gallery]({% link cms/media-storage.md %})||
...
|_[Action Log]({% link system/action-log.md %})_{:.caption-edition-ee}| [Report]({% link system/action-log.md %})<br/>[Archive]({% link system/action-log-archive.md %})|
