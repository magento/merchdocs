...
||[Archive]({% link system/action-log-archive.md %})<span class="caption-edition-ee"></span>||
...
||[Shared Catalog]({% link catalog/catalog-shared.md %})<span class="caption-edition-b2b"></span>| Manage Shared Catalog|
...
||[Companies]({% link customers/account-companies.md %})<span class="caption-edition-b2b"></span>| [ Manage Companies]({% link customers/account-company-manage.md %}) <br/>Add New Company <br/>Delete Company <br/>Reimburse Balance |
|[Carts]({% link sales/cart.md %})|[Manage carts]({% link sales/cart.md %})||
|[My Account]({% link customers/customer-account.md %})|||
|[Marketing]({% link marketing.md %})|[Promotions]({% link marketing/promotions.md %})|[Catalog Price Rule]({% link marketing/price-rules-catalog.md %}) <br/>[Cart Price Rules]({% link marketing/price-rules-cart.md %}) <br/>[Related Products Rules]({% link marketing/product-related-rules.md %})<span class="caption-edition-ee"></span><br/>[Gift Card Accounts]({% link catalog/product-gift-card-accounts.md %})<span class="caption-edition-ee"></span>|
||[Private Sales]({% link marketing/events-private-sales.md %})<span class="caption-edition-ee"></span>|[Events]({% link marketing/event-components.md %}) <br/>[Invitations]({% link marketing/invitations.md %})|
||[Communications]({% link marketing/communications.md %})|[Email Templates]({% link marketing/email-templates.md %}) <br/>[Newsletter Template]({% link marketing/newsletter-template.md %}) <br/>[Newsletter Queue]({% link marketing/newsletter-queue.md %}) <br/>[Newsletter Subscribers]({% link marketing/newsletter-subscribers.md %}) <br/>[Email Reminders]({% link marketing/email-reminder-rules.md %})<span class="caption-edition-ee"></span>|
...
||[SEO & Search]({% link marketing/seo-search.md %})|[Search Terms]({% link marketing/search-terms.md %}) <br/>[Search Synonyms]({% link marketing/search-synonyms.md %})<span class="caption-edition-ee"></span><br/>[URL Rewrites]({% link marketing/url-rewrite.md %}) <br/>[Site Map]({% link marketing/sitemap-xml.md %})|
...
|[Content]({% link content.md %}) | [Elements]({% link cms/content-elements.md %}) | [Pages]({% link cms/pages.md %})<br/>[Hierarchy]({% link cms/page-hierarchy.md %})<br/><span class="caption-edition-ee"></span>[Blocks]({% link cms/blocks.md %})<br/>[Dynamic Blocks]({% link cms/dynamic-blocks.md %})<span class="caption-edition-ee"></span><br/>[Widgets]({% link cms/widgets.md %})<br/>[Media Gallery]({% link cms/media-storage.md %})||
...
|[Action Log]({% link system/action-log.md %})<span class="caption-edition-ee"></span>| [Report]({% link system/action-log.md %})<br/>[Archive]({% link system/action-log-archive.md %})|
