...
- **Clicks** - The sum of the number of times a shopper clicks an item in the recommendation unit and the number of times the shopper clicks the <span class="btn">add to cart</span> button in the recommendation unit.
