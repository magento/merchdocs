...
|Select|Displays the attribute as a drop-down list. Click **Add New Option** to add more conditions to the drop-down menu:<br/>**Code** - A unique name to identify the attribute internally.<br/>**Label** - The name that identifies the attribute in the customer’s account dashboard.<br/>**Is Default** - Set the switch to select the default condition.<br/>**Delete Option** - To delete the option, click **Delete Option**.|
...
|Role|The role that identifies who the gift is for. <br/>Set **Is Searcheable** to: Yes / No <br/>Set **Is Listed** to: Yes / No <br/>Click **Add New Option** to add more conditions to the drop-down menu:<br/>**Code** - A unique name to identify the attribute internally.<br/>**Label** - The name that identifies the attribute in the customer’s account dashboard.<br/>**Is Default** - Set the switch to select the default condition.<br/>**Delete Option** - To delete the option, click **Delete Option**.<br/>For example, `Bride`, `Groom`, or `Partner`.|
