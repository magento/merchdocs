...
{:.bs-callout-info}
Each container is associated with one website, you only need one container per account. In case using Magento with multiple websites, you need separate containers.
