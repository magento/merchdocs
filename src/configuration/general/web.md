...
|Default No-route URL|Store View|Contains the URL of the default page that you want to appear when if a `404 Page not Found` error occurs. The default value is `cms/noroute/index`.|
...
![]({% link images/images/config-general-web-default-layouts.png %}){: .zoom}
[_Default Layouts_]({% link design/page-layout.md %})
<!--{% endif %}-->
