...
|  ---  |  ---  |  ---  |
|    Add Store Code to URLs   |   Global    |  If Web Server Rewrites are enabled, inserts the Store Code of the current view in the URL. Options: Yes / No. <br />URLs with included Store Code should be used for proper system work, if option is set to `Yes`.     |
