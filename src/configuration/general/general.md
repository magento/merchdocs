...
See [Website Restrictions]({{ site.baseurl }}{% link marketing/event-restrict-access.md %}) for specific configuration fields and options.

![General > Website Restrictions]({{ site.baseurl }}{% link images/images-ee/config-general-general-website-restrictions.png %}){: .zoom}
...
See [Store Information]({{ site.baseurl }}{% link stores/store-information.md %}) for specific configuration fields and options.

![General > Store Information]({{ site.baseurl }}{% link images/images/config-general-general-store-information.png %}){: .zoom}
