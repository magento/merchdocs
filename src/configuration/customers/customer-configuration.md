...
|Enable Autocomplete on login/forgot password forms|Website|Determines if you want to enable or disable the autocomplete on login/forgot password forms. Options: Yes / No|
