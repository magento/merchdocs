...
redirect_to: https://experienceleague.adobe.com/docs/commerce-admin/config/customers/customer-configuration.html
---
...
|Show VAT Number on Storefront|Website|Determines if the VAT number is visible to customers in the store. Options: Yes / No <br/> Affects regular non-B2B customer accounts only. B2B Company accounts have their own separate VAT Number field.|
