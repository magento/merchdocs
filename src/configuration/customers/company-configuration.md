...
Stores > Settings > [Configuration]({{ site.baseurl }}{% link stores/configuration.md %}) > [Customers]({{ site.baseurl }}{% link configuration/customers.md %}) > Company Configuration

## General

![]({{ site.baseurl }}{% link images/images-b2b/config-customers-company-configuration-general.png %}){: .zoom}
_General_

|Field|[Scope]({{ site.baseurl }}{% link configuration/scope.md %})|Description|
|--- |--- |--- |
|Allow Company Registration from the Storefront|Website|Determines if visitors to your store have the choice to [register]({{ site.baseurl }}{% link customers/customer-sign-in.md %}) for a company account or an individual account. Options: Yes / No|

## Email Options - Company Registration

![]({{ site.baseurl }}{% link images/images-b2b/config-customers-company-configuration-email-options-company-registration.png %}){: .zoom}
[_Email Options - Company Registration_]({{ site.baseurl }}{% link customers/customer-sign-in.md %})

|Field|[Scope]({{ site.baseurl }}{% link configuration/scope.md %})|Description|
|--- |--- |--- |
|Company Registration Email Recipient|Store View|The [store contact]({{ site.baseurl }}{% link stores/store-email-addresses.md %}) that is notified when a company registration request is submitted from the storefront. Options: General Contact, [Sales Representative]({{ site.baseurl }}{% link customers/account-company-sales-representative.md %}), Customer Support, Custom Email 1, Custom Email 2|
...
[_Customer-Related Emails_]({{ site.baseurl }}{% link marketing/email-company-configuration.md %})
...
[_Company Status Change_]({{ site.baseurl }}{% link customers/account-company-manage.md %})

|Field|[Scope]({{ site.baseurl }}{% link configuration/scope.md %})|Description|
|--- |--- |--- |
|Company Status Change Email Recipient|Store View|The [store contact]({{ site.baseurl }}{% link stores/store-email-addresses.md %}) that is notified whenever the status of a company changes. Options: General Contact, [Sales Representative]({{ site.baseurl }}{% link customers/account-company-sales-representative.md %}), Customer Support, Custom Email 1, Custom Email 2|
...
[_Company Credit_]({{ site.baseurl }}{% link customers/account-dashboard-company-credit.md %})

|Field|[Scope]({{ site.baseurl }}{% link configuration/scope.md %})|Description|
|--- |--- |--- |
|Company Credit Change Email Sender|Store View|The [store contact]({{ site.baseurl }}{% link stores/store-email-addresses.md %}) that is notified whenever there is a change to a company’s credit. Options: General Contact, [Sales Representative]({{ site.baseurl }}{% link customers/account-company-sales-representative.md %}), Customer Support, Custom Email 1, Custom Email 2|
...
|Reimbursed Email Template|Store View|The email template that is used by default when a [reimbursement]({{ site.baseurl }}{% link sales/credit-company-reimburse.md %}) is made to company’s credit. This email is sent to the company administrator. Default template: Credit Reimbursed|
