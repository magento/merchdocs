...
|Additionally Show Order Total Without Tax|Store View|Determines if the additional line with grand total amount without tax is displayed in the shopping cart. Options: Yes / No|
...
|Additionally Show Order Total Without Tax|Store View|Determines if the additional line with grand total amount without tax is displayed on sales documents. Options include: Yes / No|
