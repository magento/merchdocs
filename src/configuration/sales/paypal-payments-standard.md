...
redirect_to: https://experienceleague.adobe.com/docs/commerce-admin/config/sales/payment-methods/paypal-payments-standard.html
---
...
![]({% link configuration/sales/assets/paypal-standard-basic-settings.png %}){: .zoom}
_Basic Settings_
...
![]({% link configuration/sales/assets/payment-methods-paypal-payment-standard-advanced.png %}){: .zoom}
_Advanced Settings_
