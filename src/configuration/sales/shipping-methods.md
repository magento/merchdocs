...
Stores > Settings > [Configuration]({{ site.baseurl }}{% link stores/configuration.md %}) > [Sales]({{ site.baseurl }}{% link configuration/sales.md %}) > Shipping Methods
...
[_Flat Rate_]({{ site.baseurl }}{% link shipping/shipping-flat-rate.md %})
...
[_Free Shipping_]({{ site.baseurl }}{% link shipping/shipping-free.md %})
...
[_Table Rates_]({{ site.baseurl }}{% link shipping/shipping-table-rate.md %})
...
[_Magento Shipping_]({{ site.baseurl }}{% link shipping/magento-shipping-setup.md %})
<!--{% endif %}-->
...
|Countries Available for Collection Points|Website|Identifies the countries with “Click & Collect” collection points. Hold down the Ctrl key, and select each applicable country.|
...
![]({{ site.baseurl }}{% link images/images/config-sales-shipping-methods-ups-packaging-settings.png %}){: .zoom}
[_UPS Package Information_]({{ site.baseurl }}{% link shipping/ups.md %})
...
|Weight Unit|Website|Sets the default unit of measurement for product weight in your store. See also: [Dimensional Weight]({{ site.baseurl }}{% link shipping/weight-dimensional.md %}).|
...
![]({{ site.baseurl }}{% link images/images/config-sales-shipping-methods-ups-allowed-methods.png %}){: .zoom}
[_UPS Allowed Methods_]({{ site.baseurl }}{% link shipping/ups.md %})
...
|Free Method|Website|Identifies the method that is used for free shipping method through UPS. To disable free shipping, choose “None”. <br/><br/>**_Note:_** This method is similar to basic [Free Shipping]({{ site.baseurl }}{% link shipping/shipping-free.md %}), however it appears as a UPS shipping option during checkout.|
...
![]({{ site.baseurl }}{% link images/images/config-sales-shipping-methods-ups-ship-to.png %}){: .zoom}
[_UPS Applicable Countries and Other Settings_]({{ site.baseurl }}{% link shipping/ups.md %})

|Field|[Scope]({{ site.baseurl }}{% link configuration/scope.md %})|Description|
|--- |--- |--- |
|_UPS Applicable countries and other Settings_|||
|Ship to Applicable Countries|Website|Specifies which country customers are allowed to use this shipping method. Options: <br/>**All Allowed Countries** - Customers from all [countries]({{ site.baseurl }}{% link stores/country-options.md %}) specified in your store configuration can use this shipping method. <br/>**Specific Countries** - After choosing this option, the Ship to Specific Countries list appears. Select each country in the list where this shipping method can be used.|
...
![]({{ site.baseurl }}{% link images/images/config-sales-shipping-methods-usps-account-settings.png %}){: .zoom}
[_USPS Account Settings_]({{ site.baseurl }}{% link shipping/usps.md %})
...
[_USPS Packaging Settings_]({{ site.baseurl }}{% link shipping/usps.md %})
...
[_USPS Handling Fee Settings_]({{ site.baseurl }}{% link shipping/usps.md %})
...
[_USPS Allowed Methods_]({{ site.baseurl }}{% link shipping/usps.md %})
...
[_USPS Applicable Countries_]({{ site.baseurl }}{% link shipping/usps.md %})

|Field|[Scope]({{ site.baseurl }}{% link configuration/scope.md %})|Description|
|--- |--- |--- |
|_USPS Applicable Countries_|||
|Ship to Applicable Countries|Website|Specifies the countries where orders can be shipped. Options: <br/>**All Allowed Countries** - Customers from all [countries]({{ site.baseurl }}{% link stores/country-options.md %}) specified in your store configuration can use this shipping method. <br/>**Specific Countries** - After choosing this option, the Ship to Specific Countries list appears. Select each country in the list where this shipping method can be used.|
...
[_FedEx Account Settings_]({{ site.baseurl }}{% link shipping/fedex.md %})
...
[_FedEx Packaging_]({{ site.baseurl }}{% link shipping/fedex.md %})
...
[_FedEx Handling Fee_]({{ site.baseurl }}{% link shipping/fedex.md %})
...
[_FedEx Delivery Methods_]({{ site.baseurl }}{% link shipping/fedex.md %})
...
[_FedEx Applicable Countries_]({{ site.baseurl }}{% link shipping/fedex.md %})

|Field|[Scope]({{ site.baseurl }}{% link configuration/scope.md %})|Description|
|--- |--- |--- |
|_FedEx Applicable Countries_|||
|Ship to Applicable Countries|Website|Indicates the countries where your customers can ship by FedEx. Options: <br/>**All Allowed Countries** - Customers from all [countries]({{ site.baseurl }}{% link stores/country-options.md %}) specified in your store configuration  can use this shipping method. <br/>**Specific Countries** - After choosing this option, the Ship to Specific Countries list appears. Select each country in the list where this shipping method can be used.|
...
[_DHL Account Settings_]({{ site.baseurl }}{% link shipping/dhl.md %})
...
[_DHL Package Settings_]({{ site.baseurl }}{% link shipping/dhl.md %})
...
[_DHL Allowed Methods_]({{ site.baseurl }}{% link shipping/dhl.md %})
