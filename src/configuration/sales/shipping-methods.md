...
[_Magento Shipping_]({% link shipping/magento-shipping-setup.md %})
<!--{% endif %}-->
...
|Enabled for RMA|Website|When enabled, supports [return merchandise authorization]({% link sales/returns.md %}). Options: Yes / No|<!--{% endif %}-->
