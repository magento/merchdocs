...
|Shared Catalog Enabled|Website|Specifies if Magento shared catalog data is synchronized with dotdigital. Options: Yes / No|
|B2B Quote Enabled|Website|Specifies if Magento B2B quote data is synchronized with dotdigital. Options: Yes / No|<!--{% endif %}-->
