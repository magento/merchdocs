...
![]({% link configuration/dotdigital/assets/fields-mapping-address.png %}){: .zoom}
...
![]({% link configuration/dotdigital/assets/mapping-sales-fields.png %}){: .zoom}
...
![]({% link configuration/dotdigital/assets/mapping-system-values.png %}){: .zoom}
...
![]({% link configuration/dotdigital/assets/mapping-custom-atrributes.png %}){: .zoom}
...
![]({% link configuration/dotdigital/assets/data-fields-mapping-b2b-data.png %}){: .zoom}
...
![]({% link configuration/dotdigital/assets/enterprise-data.png %}){: .zoom}
...
![]({% link configuration/dotdigital/assets/data-create-data-field.png %}){: .zoom}
