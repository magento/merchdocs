...
|Brand Attribute|Website|If your product [attribute set]({{ site.baseurl }}{% link stores/attribute-sets.md %})(s) use the manufacturer attribute, it can be used as an alternative attribute for brand-related values which are synced to Engagement Cloud.|
...
![]({{ site.baseurl }}{% link images/images/config-engagement-cloud-configuration-transactional-data.png %}){: .zoom}
...
|Include Product Custom Options In Order Sync|Website|Determines if [customizable options]({{ site.baseurl }}{% link catalog/settings-advanced-custom-options.md %}) are included when orders are synchronized to Engagement Cloud. Options: Yes / No|
...
![]({{ site.baseurl }}{% link images/images/config-engagement-cloud-configuration-coupon-code.png %}){: .zoom}
_Coupon Code_
...
![]({{ site.baseurl }}{% link images/images/config-engagement-cloud-configuration-customer-preference.png %}){: .zoom}
