...
![]({% link cms/assets/page-builder-storefront-video.png %}){: .zoom}
...
![]({% link cms/assets/page-builder-media-video-toolbox.png %}){: .zoom}
_Video toolbox_
...
1. In the Page Builder panel, expand **Media** and drag a **Video** placeholder to the stage.
   ...
   ![]({% link cms/assets/page-builder-media-video-drag.png %}){: .zoom}
...
1. Hover over the video container to display the toolbox and choose the _Move_ (![]({% link images/images-ee/icon-pb-move.png %})) icon.
   ...
   ![]({% link cms/assets/page-builder-media-video-toolbox-move-col1.png %}){: .zoom}
   _Moving a video_

1. Select and drag the video to the new position, just below the red guideline.

   ![]({% link cms/assets/page-builder-media-video-toolbox-move-col2.png %}){: .zoom}
