...
1. Choose the **Store View** where the block is to be available.
   ...
   ![]({% link cms/assets/page-builder-tutorial2-block-new-google-map.png %}){: .zoom}
   _Block Information_
...
1. In the Page Builder panel under _Layout_, drag a **Row** placeholder to the top of the stage.
   ...
   ![]({% link cms/assets/page-builder-tutorial2-elements-row-drag-top.png %}){: .zoom}
...
1. On the Edit Block page, click <span class="btn">Select Block</span>.
   ...
   ![]({% link cms/assets/page-builder-add-content-block-settings-block-select.png %}){: .zoom}
   _Select Block_

1. In the search box, enter `map` and press the Enter/Return key to find the block that you created.

   ![]({% link cms/assets/page-builder-add-content-block-settings-block-find.png %}){: .zoom}
...
![]({% link cms/assets/page-builder-tutorial2-dynamic-block-row-page.png %}){: .zoom}
...
1. In the upper-right corner, click <span class="btn">Save</span> to apply the settings and return to the Page Builder workspace.
   ...
   ![]({% link cms/assets/page-builder-tutorial2-row-image.png %}){: .zoom}
...
![]({% link cms/assets/page-builder-tutorial2-column-drag.png %}){: .zoom}
...
1. In the Page Builder panel, expand **Elements** and drag a **Text** placeholder to the second column.
   ...
   ![]({% link cms/assets/page-builder-tutorial2-column-text-drag.png %}){: .zoom}
...
1. Enter the following three lines of text into the editor:
   ...
   ![]({% link cms/assets/page-builder-tutorial2-column-text-editor.png %}){: .zoom}
   _Entering text for the column_

1. Select all three lines of text and use the toolbar to set the **Line Height** to `40px`.

   ![]({% link cms/assets/page-builder-tutorial2-column-text-editor-line-height.png %}){: .zoom}
...
1. Set the **Font Size** for each line as follows:
   ...
   ![]({% link cms/assets/page-builder-tutorial2-column-text-editor-text-formatted.png %}){: .zoom}
   _Formatted text_
...
1. Expand ![Expansion selector]({% link assets/icon-display-expand.png %}) the **Related Promotions** section and click <span class="btn">Add Cart Price Rules</span>.
   ...
   ![]({% link cms/assets/page-builder-dynamic-blocks-related-promotions.png %}){: .zoom}
...
1. On the _Add Related Cart Price Rules_ page, select the checkbox for the _Buy 3 tee shirts and get the 4th free_ price rule and click <span class="btn">Add Selected</span>.
   ...
   ![]({% link cms/assets/page-builder-dynamic-block-related-cart-price-rule-list.png %}){: .zoom}
...
1. Find the _Tee Shirt Promo_ dynamic block that you created and click <span class="btn">Select</span>.
   ...
   ![]({% link cms/assets/page-builder-tutorial2-dynamic-block-edit.png %}){: .zoom}
...
1. When complete, click <span class="btn">Save</span> to save the settings and return to the Page Builder workspace.
   ...
   ![]({% link cms/assets/page-builder-tutorial2-dynamic-block-on-page.png %}){: .zoom}
...
1. Change the column width:
   ...
   - Hold down the mouse button and drag the border two divisions to the left.
      ...
      ![]({% link cms/assets/page-builder-tutorial2-dynamic-block-edit-column-width.png %}){: .zoom}
      _Grid divisions_
      ...
      ![]({% link cms/assets/page-builder-tutorial2-dynamic-block-edit-column-width-changed.png %}){: .zoom}
...
1. Change the text color:
   ...
   ![]({% link cms/assets/page-builder-tutorial2-dynamic-block-edit-text-color.png %}){: .zoom}
   _Text color_
