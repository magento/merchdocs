...
The following tutorial illustrates the difference between [simple blocks]({{ site.baseurl }}{% link cms/blocks.md %}) and [dynamic blocks]({{ site.baseurl }}{% link cms/page-builder-add-dynamic-block.md %}), and how to use Page Builder to create each type of block.
...
1. In the upper-right corner, click <span class="btn">Add New Block</span>. Then, do the following:
    ...
    - Choose the **Store View** where the block is to be available.
        ...
        ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-block-new-google-map.png %}){: .zoom}
        _Block Information_
...
1. In the Page Builder panel under **Layout**, drag a row placeholder to the top of the stage.
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-elements-row-drag-top.png %}){: .zoom}
...
1. Hover over the empty block container. Then, choose **Settings** (![]({{ site.baseurl }}{% link images/images-ee/icon-pb-settings.png %})) in the toolbox and do the following:
    ...
    - On the Edit Block page, click <span class="btn">Select Block</span>.
        ...
        ![]({{ site.baseurl }}{% link images/images-ee/page-builder-add-content-block-settings-block-select.png %}){: .zoom}
        _Select Block_
...
![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-dynamic-block-row-page.png %}){: .zoom} 
...
1. In the upper-right corner, click <span class="btn">Add Dynamic Block</span>. Then, do the following:
    ...
    - In the **Customer Segment** list, select the checkbox of each segment that you want to apply to the dynamic block. Then, click <span class="btn">Done</span> to save the setting.
        ...
        For this example, we created two [customer segments]({{ site.baseurl }}{% link marketing/customer-segments.md %}) that identify registered customers by gender. This dynamic block appears only to registered female customers who are logged in to their accounts while they shop in your store.
...
1. In the Page Builder panel under _Media_, drag an **Image** placeholder to the row. Click <span class="btn">Select from Gallery</span> and choose the `wide-banner-background.png` image.
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-row-image.png %}){: .zoom}
    _Row with Image_

1. Hover over the row container. Then, choose **Settings** (![]({{ site.baseurl }}{% link images/images-ee/icon-pb-settings.png %})) in the toolbox and scroll down to the **Layout** section.
...
![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-column-drag.png %}){: .zoom}
_Two Equal Columns_
...
1. In the Page Builder panel under **Elements**, drag a **Text** placeholder to the second column.
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-column-text-drag.png %}){: .zoom}
...
1. Enter the following 3 lines of text into the editor:
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-column-text-editor.png %}){: .zoom}
    _Enter Text_

1. Select all three lines of text. Then on the toolbar, set **Line Height** to `40px`.

    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-column-text-editor-line-height.png %}){: .zoom}
    _Line Height_
...
1. Set the **Font Size** for each line as follows:
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-column-text-editor-text-formatted.png %}){: .zoom}
    _Formatted Text_

**Add a Link**

In the first tutorial, you learned how to use the [Button]({{ site.baseurl }}{% link cms/page-builder-elements-buttons.md %}) content type to create a link. This example shows how to insert a link from the editor toolbar.
...
1. In the text editor, select the `Shop Tees >` text in the third line. Then, on the editor toolbar, choose **Bold** (![]({{ site.baseurl }}{% link images/images/editor4-toolbar/btn-bold.png %})).

1. Again select the `Shop Tees >` text in the third line. Then, choose **Insert/edit link** (![]({{ site.baseurl }}{% link images/images-ee/icon-pb-add-link.png %})) on the editor toolbar.
...
1. Expand the **Related Promotions** section of the New Dynamic Block page and click <span class="btn">Add Cart Price Rules</span>.
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-dynamic-blocks-related-promotions.png %}){: .zoom}
...
1. On the Add Related Cart Price Rules page, select the checkbox for the "Buy 3 tee shirts and get the 4th fee" price rule. Then, click <span class="btn">Add Selected</span>.
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-dynamic-block-related-cart-price-rule-list.png %}){: .zoom}
...
1. Open the Simple Page that you created in the [first tutorial]({{ site.baseurl }}{% link cms/page-builder-tutorial1-simple-page.md %}) in edit mode. Then expand the **Content** section and do the following:
   ...
   - Hover over the dynamic block container. Then in the toolbox, choose Settings (![]({{ site.baseurl }}{% link images/images-ee/icon-pb-settings.png %})).
   ...
   - On the Select Dynamic Block page, find the "Tee Shirt Promo” dynamic block that you created and click <span class="btn">Select</span>. Then, click <span class="btn">Add Selected</span>.
        ...
        ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-dynamic-block-select.png %}){: .zoom}
        _Select Dynamic Block_

        A summary of the dynamic block information appears below.

        ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-dynamic-block-edit.png %}){: .zoom}
...
1. When complete, click <span class="btn">Save</span> to save the settings and return to the Page Builder workspace.
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-dynamic-block-on-page.png %}){: .zoom}
...
1. To change the column width, do the following:
   ...
   - Hold down the mouse button, and drag the border two divisions to the left.
        ...
        ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-dynamic-block-edit-column-width.png %}){: .zoom}
        _Grid Divisions_
        ...
        ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-dynamic-block-edit-column-width-changed.png %}){: .zoom}
...
1. To change the text color, do the following:
   ...
   - On the Editor toolbar, choose **Text Color**. Then, click the **White** swatch.
    ...
    ![]({{ site.baseurl }}{% link images/images-ee/page-builder-tutorial2-dynamic-block-edit-text-color.png %}){: .zoom}
    _Text Color_
