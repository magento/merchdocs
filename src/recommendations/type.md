...
|Type|Description|
|---|---|
|(Conversion) View to cart| Recommends products with the highest view-to-cart conversion rate. Of all shopper sessions that viewed the product, the percentage that added the product to the cart.<br /><br />Where used:<br /><br />- Home page<br />- Category<br />- Product detail<br />- Cart<br />- Confirmation<br /><br />Suggested labels:<br /><br /> - Top sellers<br />- Popular items<br />- You might be interested in|
|(Conversion) View to purchase|Recommends products with the highest view-to-purchase conversion rate. Of all the shopper sessions that viewed the product, the percentage that purchased the product.<br /><br />Where used:<br /><br />- Home page<br />- Category<br />- Product detail<br />- Cart<br />- Confirmation<br /><br />Suggested labels:<br /><br /> -Top sellers<br />- Popular items<br />- You might be interested in |
