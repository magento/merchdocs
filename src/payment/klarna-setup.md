...
1. In the upper-left corner, choose the **Website** where the configuration applies. If your installation has only one website, accept the `Default Config` setting.
