...
1. Expand ![]({% link assets/icon-display-expand.png %}) the **Basic Settings - PayPal Payflow Link** section.
   ...
   ![Basic Settings]({% link configuration/sales/assets/payment-methods-paypal-payflow-link-basic-settings.png %}){: .zoom}
...
1. Expand ![]({% link assets/icon-display-expand.png %}) the **Advanced Settings** section.
   ...
   ![Advanced Settings]({% link configuration/sales/assets/payment-methods-paypal-payflow-link-advanced-settings.png %}){: .zoom}
...
1. Expand ![]({% link assets/icon-display-expand.png %}) the **Basic Settings - PayPal Express Checkout** section.
   ...
   ![Basic Settings]({% link configuration/sales/assets/payment-methods-paypal-payflow-link-express-checkout-basic-settings.png %}){: .zoom}
...
1. Expand ![]({% link assets/icon-display-expand.png %}) the **Advanced Settings** section.
   ...
   ![Advanced Settings]({% link configuration/sales/assets/payment-methods-paypal-payflow-link-express-checkout-advanced-settings.png %}){: .zoom}
