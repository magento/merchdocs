...
redirect_to: https://experienceleague.adobe.com/docs/commerce-admin/start/reporting/customer-reports.html
---
...
![]({% link reports/assets/customer-order-count.png %}){: .zoom}
*Order Count Report*
