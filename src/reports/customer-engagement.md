...
1. To specify the email notification frequency and the time interval for error reporting, set **Alert Frequency** to one of the options: 1 hour, 12 hours, 24 hours, 48 hours, 72 hours.
