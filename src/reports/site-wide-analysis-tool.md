...
![Site-Wide Analysis Tool Dashboard]({% link reports/assets/reports-swat-dashboard.png %}){: .zoom}
...
1. Select the **Reports** > _System Insights_ > **Site-Wide Analysis Tool** role resource.
   ...
   ![Select the Site-Wide Analysis Tool permission]({% link reports/assets/reports-swat-role-access.png %}){: width="330px"}<br/>
...
1. Read the _Terms of Use_ for the Site Wide Analysis Tool and click <span class="btn">Accept</span> to continue.
   ...
   ![Terms of Use]({% link reports/assets/reports-swat-tos.png %}){: .zoom}
   _Terms of Use_

1. At the top of the dashboard, click the tab that you want to see.

   ![Information tab]({% link reports/assets/reports-swat-information-tab.png %}){: .zoom}
...
1. Click <span class="btn">Generate Report</span>.
   ...
   ![Report Settings]({% link reports/assets/reports-swat-report-settings.png %}){: .zoom}
   _Report Settings_
