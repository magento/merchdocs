...
<span class="caption-edition-ee">_[Customer Account Sign Up Form]({% link configuration/customers/customer-configuration.md %})_</spam>
...
1. Scroll up to the top of the page. Then in the upper-left corner, set the scope of the configuration to one of the following:
   ...
   <span class="caption-edition-ee">_[Configuration Scope]({% link configuration/scope.md %})_</span>
...
1. Return to the Name and Address Options section of the Customer Configuration page.
   ...
   <span class="caption-edition-ee">_[Name and Address Options]({% link configuration/customers/customer-configuration.md %})_</span>
...
<span class="caption-edition-ce">_[Customer Account Sign Up Form]({% link configuration/customers/customer-configuration.md %})_</span>
...
1. Expand ![]({% link images/images/btn-expand.png %}){: .Inline} the **Name and Address Options** section.
   ...
   <span class="caption-edition-ce">_[Name and Address Options]({% link configuration/customers/customer-configuration.md %})_</span>
...
1. Scroll back up to the top of the page. Then in the upper-left corner, set the scope of the configuration to one of the following:
   ...
   <span class="caption-edition-ce">_[Configuration Scope]({% link configuration/scope.md %})_</span>
...
1. To include a prefix (such as Mr. or Mrs.) as part of the name, set **Show Prefix** to `Yes`.
   ...
   <span class="caption-edition-ce">_[Prefix in Customer Sign Up Form]({% link configuration/customers/customer-configuration.md %})_</span>
...
1. To include the date of birth, set **Show Date of Birth** to one of the following:
   ...
   <span class="caption-edition-ce">_[Date of Birth in Customer Sign Up Form]({% link configuration/customers/customer-configuration.md %})_</span>
...
1. To include a field for gender in the customer form, set **Show Gender** to one of the following:
   ...
   <span class="caption-edition-ce">_[Gender Options in Customer Sign Up Form]({% link configuration/customers/customer-configuration.md %})_</span>
