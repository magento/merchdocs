...
| Fixed | Specifies the final product price. For example, if you enter a fixed price of $10.00, the price in the storefront for the corresponding company is $10.00. **Note:** Minimum value among Base Price and entered Fixed value vil be selected as final product price |
