...
1. For **Currency Conversion**, select an option. The default is `Disabled`.
   ...
   The options in this drop-down are dependent on your [Magento currency]({{ site.baseurl }}{% link configuration/general/currency-setup.md %}) settings. If no options are available, you may need to set up your currency settings.
