...
If you have modified the default [Google settings]({% link stores/compliance-gdpr-google.md %}) to comply with the [General Data Protection Regulation]({% link stores/compliance-gdpr.md %}), it is no longer necessary to obtain user consent for the use of Google Analytics cookies.
