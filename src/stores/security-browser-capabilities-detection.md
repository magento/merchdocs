...
For technical information, see [Supported browsers]({{ site.devdocs_url }}/install-gde/system-requirements_browsers.html#supported-browsers) in the developer documentation.
