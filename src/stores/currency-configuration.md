...
1. Define the scope of the base currency:
   ...
   - In the left panel under _Catalog_, choose **Catalog**. Then, scroll down and expand ![Expansion selector]({% link images/images/btn-expand.png %}) the **Price** section (This section only appears in the **Store View:** _Default config_ scope).
