...
|[GraphQL](https://devdocs.magento.com/live-search/graphql/) |Developers who are logged into the Admin of your store can compose and test queries with actual data from your catalog. To learn more, go to [GraphQL Overview](https://devdocs.magento.com/guides/v2.4/graphql/) in the Live Search Developer Documentation.|
