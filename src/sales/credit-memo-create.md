...
1. Find the completed order in the grid and click the **View** link in the _Action_ column to open the order.

1. In the button bar at the top of the page, click **Credit Memo**.
...
1. Set the return to stock option:
    ...
    - If the product is to be returned to inventory, select the **Return to Stock** checkbox. With Magento Inventory Management enabled, the inventory quantity returns to the source that sent the shipment.
