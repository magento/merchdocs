...
- If the Payment Action for your configured payment method is set to `Authorize`, you must first generate the invoice from the _Admin_ before a credit memo can be created.
