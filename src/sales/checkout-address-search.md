...
![]({{ site.baseurl }}{% link images/images-ee/storefront-checkout-address-search.png %}){: .zoom}
...
![]({{ site.baseurl }}{% link images/images-ee/storefront-checkout-address-search-no-default.png %}){: .zoom}
...
![]({{ site.baseurl }}{% link images/images-b2b/storefront-checkout-quote-address-limit.png %}){: .zoom}
