...
One of the most important areas in creating and managing your store is product creation, category, and inventory management. The Admin provides a number of tools you will use for the initial setup for your store, as well as maintaining your store and optimizing your business. <!--{% if "Default.B2B Only" contains site.edition %}-->Magento Commerce for B2B users can also set up [shared  catalogs]({% link catalog/catalog-shared.md %}) with curated selections of products with custom pricing that can be limited to specific companies.<!--{% endif %}-->
