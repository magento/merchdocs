...
You can view your Amazon order information in the _Recent Orders_ section of the store dashboard. Also see [Manage Orders and Fulfillment]({% link sales-channels/asc/managing-orders.md %}). Also see [Manage Orders and Fulfillment]({% link sales-channels/asc/managing-orders.md %}).
