...
In the _Amazon Stores_ view on Amazon Sales Channel home page, you can click **View Store** for a store (in Active or Inactive status) to access the store's dashboard.
