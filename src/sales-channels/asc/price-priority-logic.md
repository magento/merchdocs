...
To view your stores' sort order, click **Stores** > **All Stores** on the _Admin_ page. In the _Web Site_ column, click the website name. The _Web Site Information_ page contains the Sort Order field, which determines the priority of the website. A value of `1` indicates the highest priority.
