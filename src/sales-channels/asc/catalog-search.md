...
1. In the **ASIN** field, choose the product attribute you created for the Amazon ASIN value.
...
1. In the **EAN** field, choose the product attribute you created for the Amazon EAN value.
...
1. In the **GCID** field, choose the product attribute you created for the Amazon GCIN value.
...
1. In the **ISBN** field, choose the product attribute you created for the Amazon ISBN value.
...
1. In the **UPC** field, choose the product attribute you created for the Amazon UPC value.

   The Universal Product Code (UPC) is a 12-digit bar code used extensively for retail packaging in United States.

1. In the **General Search** field, choose the product attribute you want to use for a general search match.
