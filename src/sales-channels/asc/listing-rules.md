...
You can access the listing rules for an Active or Inactive store in the [store dashboard]({% link sales-channels/asc/amazon-store-dashboard.md %}). In the _I Want To..._ section, click **Listing Rules**.
