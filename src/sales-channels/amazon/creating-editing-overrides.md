...
1. In the Action column, click **Select** and then click **Create Override**. The Product Listing Overrides screen displays.
    ...
    ![]({{ site.baseurl }}{% link images/images/sales-channels/amazon/amazon-select-create-override.png %})
...
![]({{ site.baseurl }}{% link images/images/sales-channels/amazon/amazon-overrides-edit.png %}){: .zoom}
...
1. In the Action column, click **Select** and then click **Edit Overrides**. The Product Listing Overrides screen displays just as when creating an override.
    ...
    ![]({{ site.baseurl }}{% link images/images/sales-channels/amazon/amazon-select-edit-overrides.png %})
...
![]({{ site.baseurl }}{% link images/images/sales-channels/amazon/amazon-overrides-edit-2.png %}){: .zoom}
...
1. In the Actions drop-down, click **Edit Listing Overrides**. The Product Listing Overrides screen displays just as when creating an override.
    ...
    ![]({{ site.baseurl }}{% link images/images/sales-channels/amazon/amazon-actions-edit-listing-overrides.png %})
