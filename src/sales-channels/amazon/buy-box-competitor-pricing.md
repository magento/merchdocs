...
[Intelligent repricing rules]({{ site.baseurl }}{% link sales-channels/amazon/intelligent-repricing-rules.md %}) can be configured to adjust your pricing based on the Amazon Buy Box price.

![]({{ site.baseurl }}{% link images/images/sales-channels/amazon/amazon-listing-details-buy-box.png %}){: .zoom}
